...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MGMT_SUITFU_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_NCS_DEVICE_ID_STATIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_NCS_DEVICE_ID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_NCS_HW_VERSION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_NCS_FW_TYPE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_NCS_FW_VERSION_AUTO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_NCS_FW_VERSION_PREFIX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_NCS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_NCS_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_POSIX_ENV_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_BASE_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CAP_COMMON_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PBP_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HFP_AG_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HRS_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_TPS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_TPS_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_IAS_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SETTINGS_LOG_LEVEL, 2);
